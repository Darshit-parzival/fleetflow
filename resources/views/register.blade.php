    ...
    <div class="card shadow-lg border-0 rounded-4 p-4" style="width: 100%; max-width: 420px;">
        ...
        <form method="POST" action="{{ route('register.submit') }}">
                ...
                <div class="row g-3">
                    ...
                    @foreach ($roles as $role)
                        <div class="col-6">
                            ...
                            <input type="checkbox" class="role-checkbox" name="roles[]" value="{{ $role->id }}"
                                id="role{{ $role->id }}">
            ...
            <div class="mb-3">
                ...
                <input type="password" name="password" class="form-control rounded-3" placeholder="Create password">
            </div>
